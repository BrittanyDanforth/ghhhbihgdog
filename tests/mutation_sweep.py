...
MUTATIONS = [
 ...
 ('a hex-encoded memo is embedded as ASCII hex', 'btc_forwarder',
  ...
  '    if False:',
  ['test_btc_forwarder']),
 ('a zero output limit (a swap at any price) is signed', 'btc_forwarder',
  '    if limit <= 0:',
  '    if limit < 0:',
  ['test_btc_forwarder']),
 ('an output limit under the worst-case arrival is signed', 'btc_forwarder',
  '    if limit < floor:',
  '    if False:',
  ['test_btc_forwarder']),
