...
MUTATIONS = [
 ...
 ('the forwardable floor is removed', 'gs_wake_agent',
  ...
  '            if False:',
  ['test_wake_agent']),
 ('the floor forgets the fee allowance', 'gs_wake_agent',
  '    return int(proto.DEPOSIT_MIN_SAT) + int(bound) * int(ceiling)',
  '    return int(proto.DEPOSIT_MIN_SAT)',
  ['test_wake_agent']),
