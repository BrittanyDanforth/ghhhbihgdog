...
MUTATIONS = [
 ...
 ('a seed that does not derive the watched xpub signs anyway', 'btc_forwarder',
  ...
  '    if False:',
  ['test_btc_forwarder']),
 ('an UNCONFIRMED output becomes an input of the forward', 'btc_forwarder',
  '    settled = [u for u in picture["utxos"] if u["confirmations"] > 0\n               and u["value"] > 0]',
  '    settled = [u for u in picture["utxos"] if True\n               and u["value"] > 0]',
  ['test_btc_forwarder']),
