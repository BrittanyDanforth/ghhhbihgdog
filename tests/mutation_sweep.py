...
MUTATIONS = [
 ...
 ('the moves set aside as undecided are never refused', 'btc_forwarder',
  '    if _undecided:\n        integrity_log("forward", "hand_move_undecided")\n',
  '    if False:\n        integrity_log("forward", "hand_move_undecided")\n',
  ['test_btc_forwarder']),
 ...
 ("the THORNode's answer about another transaction is taken", 'btc_forwarder',
  '            or str(tx.get("id") or "").lower() != str(txid).lower() \\\n',
  '            or False \\\n',
  ['test_btc_forwarder']),
 ("the THORNode's answer about another chain is taken", 'btc_forwarder',
  ...
  '            or False:\n        return None\n    stages = st.get("stages")\n',
  ['test_btc_forwarder']),
 ('a finalised inbound with no height is recorded at a made-up one', 'btc_forwarder',
  '        h = fallback\n',
  '        h = fallback or 1\n',
  ['test_btc_forwarder']),
