...
MUTATIONS = [
 ...
 ('an outpoint a plan of ours signed passes as dust', 'btc_forwarder',
  '            _hand = (not _extra_ins & _signed_ops\n',
  '            _hand = (True\n',
  ['test_btc_forwarder']),
 ...
 ('a hand move is recorded in txid order', 'btc_forwarder',
  '                       for i in _largest_first(\n',
  "                       for i in (lambda _x: sorted(_x, key=lambda u: (str(u.get('tx_hash') or ''), int(u.get('vout') or 0))))(\n",
  ['test_btc_forwarder']),
 ...
 ('the dust allowance is one per spend', 'btc_forwarder',
  '                     and _dust_used + sum(_xval.values())\n',
  '                     and sum(_xval.values())\n',
  ['test_btc_forwarder']),
 ...
 ('a hand move is recorded without its values', 'btc_forwarder',
  '                _note_values(plan, s.get("inputs"))\n',
  '',
  ['test_btc_forwarder']),
